...
namespace VkApplication {
	...
	VkImageView MainVulkApplication::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
	...
	VkSurfaceFormatKHR MainVulkApplication::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
	...
	SwapChainSupportDetails MainVulkApplication::querySwapChainSupport(VkPhysicalDevice device) {
	...
	VkExtent2D MainVulkApplication::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
	...
	void MainVulkApplication::createSwapChain() {
	...
	void MainVulkApplication::cleanupSwapChain() {
	...
	VkFormat MainVulkApplication::findDepthFormat() {
